...
GROUP BY 
	...
	-- 4.Which operator causes more downtime and through which factors?
...
ORDER BY 
	...
	-- 8. Which products experience more downtime?

	SELECT 
    lp.Product,
    SUM(ld.Minutes) AS Total_Downtime_Minutes
FROM 
    Line_downtime ld
JOIN 
...
ORDER BY 
	...
	-- 9. How does downtime vary over time?
...
ORDER BY 
	...
	-- 10. How does downtime vary by day of the week?
...
ORDER BY 
	...
	-- 11. How does downtime vary by work shifts?
...
ORDER BY 
	...
	--	How much production time was lost due to downtime?

	SELECT SUM(Minutes) AS Total_Lost_Production_Time_Minutes
FROM Line_downtime;
...
SELECT 
    lp.Product,
    SUM(ld.Minutes) AS Lost_Production_Time_Minutes
FROM 
    Line_downtime ld
JOIN 
    Line_productivity lp
...
GROUP BY 
    lp.Product
ORDER BY 
    Lost_Production_Time_Minutes DESC;

	-- 12. How does downtime impact productivity?
...
ORDER BY 
	...
	-- 13. How would the factory have performed without downtime?
